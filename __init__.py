...
concepts = {
    ...
    'household': concept('household', ['age', 'education', 'income', 'value', 'yearoccupied', 'race', 'language', 'children', 'size'], function=lambda x, *args, **kwargs: x.tohistogram(*args, how='average', **kwargs)),
