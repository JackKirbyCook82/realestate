...
@utilities('housing')
@UtilityFunction.register('housing', 'cobbdouglas', parameters=('size', 'quality', 'location',))
...
@utilities('household')
@UtilityFunction.register('household', 'cobbdouglas', parameters=('housing', 'consumption',))
